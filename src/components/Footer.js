...
import { Building, Phone, Mail, MapPin, Facebook, Instagram, Twitter, Linkedin, ArrowUp, Award, Briefcase } from 'lucide-react';
...
const Footer = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1 space-y-8">
            <Link
              to="/"
              className="group flex items-center space-x-4 focus:outline-none focus:ring-0 focus:border-0"
            >
              ...
              {socialLinks.map((social, index) => {
                ...
                return (
                  <a
                    key={index}
                    href={social.href}
                    className={`group relative w-12 h-12 bg-white-800 rounded-xl flex items-center justify-center text-gray-400 ${social.color} transition-all duration-300 hover:scale-110 focus:outline-none focus:ring-0 focus:border-0`}
                  >
            ...
            <ul className="grid grid-cols-2 gap-x-8 gap-y-4">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <Link
                    to={link.path}
                    className="group flex items-center text-white-400 hover:text-white-500 transition-all duration-300 focus:outline-none focus:ring-0 focus:border-0"
                  >
                    <svg
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-6">
              <div className="group flex items-start space-x-4 p-4 rounded-xl bg-gray-800 hover:bg-gray-700 transition-colors duration-300 focus:outline-none focus:ring-0 focus:border-0">
                ...
                <a
                  ...
                  className="text-white-300 focus:outline-none focus:ring-0 focus:border-0"
                >
                  {contactData.address}
                </a>
              </div>

              <div className="group flex items-center space-x-4 p-4 rounded-xl bg-gray-800 hover:bg-gray-700 transition-colors duration-300 focus:outline-none focus:ring-0 focus:border-0">
              ...
              <div className="group flex items-start space-x-4 p-4 rounded-xl bg-gray-800 hover:bg-gray-700 transition-colors duration-300 focus:outline-none focus:ring-0 focus:border-0">
                ...
                <div className="flex-1 min-w-0">
                  <a
                    ...
                    className="block text-white-300 break-words focus:outline-none focus:ring-0 focus:border-0"
                  >
                    {contactData.email}
                  </a>
                </div>
      ...
      {/* Bottom Bar */}
      <div className="w-full mt-12 border-t border-gray-700 pt-4 flex flex-col lg:flex-row gap-2 text-gray-800 bg-yellow-400 px-4 py-2">
        ...
        <div className="w-full lg:w-[55%] flex justify-center lg:justify-end">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="cursor-pointer font-bold text-[15px] text-gray-800 hover:text-blue-600 transition-colors text-center lg:text-right focus:outline-none focus:ring-0 focus:border-0"
          >
      ...
      <button
        onClick={scrollToTop}
        className="fixed bottom-8 right-8 group w-14 h-14 bg-gray-800 text-white-500 
                   rounded-full shadow-lg hover:bg-white-500 hover:text-white transform 
                   hover:scale-110 transition-all duration-500 flex items-center justify-center z-50 
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-28 right-8 group w-14 h-14 bg-green-500 text-white 
                   rounded-full shadow-lg hover:bg-green-600 transform hover:scale-110 
                   transition-all duration-500 flex items-center justify-center z-50 animate-spin-slow
                   focus:outline-none focus:ring-0 focus:border-0"
      >
