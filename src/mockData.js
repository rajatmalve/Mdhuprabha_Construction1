...
export const projectsData = [
  ...
  },
  {
    ...
    features: [
      "Lift with inverter Back Up.",
      "Allotted car park to individual flat owners.",
      "Automatic level water controller to give uninterrupted water supply.",
      "Branded modular switches.",
      "Elegant elevation.",
      "AC points in all the three bed rooms.",
